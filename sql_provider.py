...
class SQLProvider:
    ...
    def __init__(self, file_path: str) -> None:
        ...
        for file in os.listdir(file_path):  # цикл по всем файлам в директории; os.listdir(file_path) - возвращает список файлов в дирекории
...
# Словарь перекастовывается в тип Template.

# Метод Template.substitute предоставляет возможность
